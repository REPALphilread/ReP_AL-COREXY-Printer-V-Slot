...
leveling-strategy.three-point-leveling.point1        180.0, 30.0     # The first probe point (X, Y)
leveling-strategy.three-point-leveling.point2        300.0, 300.0   # The second probe point (X, Y)
leveling-strategy.three-point-leveling.point3        60.0, 300.0     # The third probe point (X, Y)
...
leveling-strategy.three-point-leveling.probe_offsets -40,-40,0          # The probe offset from nozzle, must be X,Y,Z (Z should always be 0), 
...
# Rectangle Levelling strategy
# =======================================
leveling-strategy.rectangular-grid.enable               true   	    # The strategy must be enabled in the config, as well as the zprobe module.
leveling-strategy.rectangular-grid.x_size               290         # size of bed in the X axis
...
leveling-strategy.rectangular-grid.do_home              false       # True or False       
leveling-strategy.rectangular-grid.probe_offsets        -40,-40,0       # Optional probe offsets from the nozzle or tool head
